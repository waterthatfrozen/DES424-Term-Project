        ...
        <div className='signin--container'>
          ...
          <form onSubmit={handleSubmit} className='form--container'>
            <div className='form--group'>
              <h4>Username</h4>
              <input className='form--input' type="username" placeholder='Username' name='username' onChange={handleChange} value={formdata.username}/>
            </div>
            ...
            <div className='form--group'>
              ...
              <a onClick={forgetPassword} className='a--password'>Forget a password?</a>
            </div>
          ...
          <span className='span--signup'>
            ...
            <a className="a--signup" onClick={() => navigateTo("/signup")}>Sign Up</a>
          </span>
        </div>
      </body>
  )
